...
vim.api.nvim_set_hl(0, "LspReferenceText", {fg = oxocarbon.none, bg = blend_hex(base00, oxocarbon.base05, 0.15)})
vim.api.nvim_set_hl(0, "LspReferenceread", {fg = oxocarbon.none, bg = blend_hex(base00, oxocarbon.base05, 0.15)})
vim.api.nvim_set_hl(0, "LspReferenceWrite", {fg = oxocarbon.none, bg = blend_hex(base00, oxocarbon.base05, 0.15)})
...
vim.api.nvim_set_hl(0, "GitSignsCurrentLineBlame", {link = "DiffText"})
